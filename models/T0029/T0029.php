...
class models_T0029 extends models
{
    ...
    public function retornaArquivoUnico($codigo)
    {
        $sql = "SELECT T1.T055_nome     Nome
                     ...
                     , date_format(T1.T055_dt_upload,'%d/%m/%Y') DataUpload
    ...
    public function retornaTipoArquivos()
    {
       return $this->query("SELECT DISTINCT TF1.T056_codigo	Codigo
                         ...
                         LEFT JOIN T055_arquivos TJ1 ON ( TF1.T056_codigo = TJ1.T056_codigo)
...
//                          ORDER BY 1 DESC");
    ...
    {
        return $this->query("SELECT T77.T077_codigo     Codigo
                                  , T77.T077_nome       Nome
                               FROM T077_departamento T77
                               LEFT JOIN (  
                                        SELECT DISTINCT T5577.T077_codigo Codigo
                                          FROM T055_T077 T5577
    ...
    {
        $sql    =   "   SELECT T77.T077_codigo    DptoCodigo  
                             , T77.T077_desc      DptoDescricao
                             , T77.T077_nome      DptoNome
                             , T77.T077_pai       DptoPai
                          FROM T077_departamento  T77";
    ...
    public function  retornaEmail($user)
    {
        $sql = "SELECT T04.T004_email Email FROM T004_usuario T04 WHERE T004_login = '$user'";
        
        return $this->query($sql);
    }
    
    public function  retornaEmailPerfil($CodigoPerfil)
    {
        $sql = "  SELECT T04.T004_email
                    FROM T004_T009 T0409
                    JOIN T004_usuario T04 ON T0409.T004_login = T04.T004_login
                   WHERE T009_codigo  = $CodigoPerfil";
        
        return $this->query($sql);
    }
    
    public function retornaEmailUsuariosPerfil($codigoPerfil)
    {
        $sql    =   " SELECT T04.T004_email email
                        FROM T004_T009 T0409
                        JOIN T004_usuario T04 ON T04.T004_login = T0409.T004_login
                       WHERE T0409.T009_codigo  = $codigoPerfil";
