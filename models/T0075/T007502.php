...
//    
//    
//    public function retornaPagEmporium($dataini, $datafim)
// 
//    {
//        
////        $sql = "SELECT store_key        StoreKey
////                     , pos_number       PosNumber
////                     , sum(amount_due)   Soma
////                     , count(*) qtd
////                     , ( select amount from accum_media 
////                          where store_key = $loja
////                          and pos_number = $pv 
////                          and fiscal_date = '$dataini'
////                          and accum_media.media_id = 21) estorno
////                    , ( select quantity from accum_media 
////                          where store_key = $loja
////                          and pos_number = $pv 
////                          and fiscal_date = '$dataini'
////                          and accum_media.media_id = 21) QtdEstorno
////                FROM sale 
////               WHERE fiscal_date = '$dataini'    
////                 AND store_key = '$loja'
////                 AND pos_number = '$pv'
////                 AND sale_type = '14'
...
//        
//        $sql = "
// select sum(amount_due) as ValorEmp
//       , count(*) as QtdEmp 
//       ,store_key
//       ,pos_number 
//from  sale
