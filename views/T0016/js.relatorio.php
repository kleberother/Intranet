...
function select()
{
 ...
 $ap                  = $obj->retornaNotasFornecedor($this->codFornecedor,$this->data_inicial,$this->data_final);
 return $ap;
}
...
// HEADER DO RELATÓRIO
$this->Cell(176,10, $this->nomeFornecedor,"B",0,"L");
$this->Cell(50,10, "DE: ".$this->data_inicial,"B",0,"L");
$this->Cell(50,10, "ATE: ".$this->data_final,"B",1,"L");
...
$this->Cell(20,8, $valores['DataElaboracao'],1,0,"L");
$this->Cell(20,8, $valores['NotaFiscal'],1,0,"L");
