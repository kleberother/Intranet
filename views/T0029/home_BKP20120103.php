...
//Função para verificar se os departamentos pais existem filhos
function verificaDeptos($i, $CodigoPai, $Departamentos)
{
    $obj    =   new models_T0029();
    ...
    {        
        $i++                                                                ;
        $Departamentos[$i]['DptoCodigo']    =   $valores['DptoCodigo']      ;
        $Departamentos[$i]['DptoDescricao'] =   $valores['DptoDescricao']   ;
        $Departamentos[$i]['DptoNome']      =   $valores['DptoNome']        ;
        $Departamentos[$i]['DptoPai']       =   $valores['DptoPai']         ;

        //Verifica se tem filho
        verificaDeptos($i, $valores['DptoCodigo'], $Departamentos);
...
$i              =   -1      ;
$Departamentos  =   Array() ;
$Retorno    =   verificaDeptos($i, $CodigoPai, $Departamentos);
print_r($Retorno);
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="departamento">
                                    <option value="">Selecione...</option>
                                    <?php foreach($Departamentos as $campos=>$valores){echo $valores;}?>
                                </select>
                            </td>
                            <td>
