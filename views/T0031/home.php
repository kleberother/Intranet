 ...
 * Descrição: Listagem de dados da tabela de Deslocamentos
 * Entrada:   
 * Origens:   
...
$Deslocamentos = $obj->retornaDeslocamentos();
    ...
    <div id="ferr-conteudo">
        <span class="ferr-cont-menu">
            <ul>
                ...
                <li><a href="?router=T0031/home" class="active">Listar</a></li>
<!--                <li><a href="?router=T0031/novo">Novo</a></li>-->
            </ul>
        </span>
    </div>
</div>
	...
	<table class="ui-widget ui-widget-content tablesorter" id="tablesorter">
		<thead>
			<tr class="ui-widget-header ">
				...
				<th>Loja de Destino          </th>
                                <th width="10%">Distância (Km)</th>
				<th width="12%">Ações        </th>
			</tr>
		</thead>
		<tbody> <?php $i=1;?>
                        <?php foreach($Deslocamentos as $campos=>$valores) {?>
			<tr class="dados">
				<td><?php echo $valores['CodigoOrigem'];?> - <?php echo $valores['NomeOrigem'];?></td>
				<td><?php echo $valores['CodigoDestino'];?> - <?php echo $valores['NomeDestino'];?></td>
				<td><?php echo $valores['KM'];?></td>
                                <td class="acoes">
