...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="template/css/estilo-painel-linux.css" rel="stylesheet" type="text/css" />
                    ...
                    <div class="tabela-conteudo">
                        ...
                        foreach($ListaProdutos as $campos=>$valores){ 
                           ...
                           { 
                             ...
                             {
                                 if(is_null($valoresGrupo['DescricaoPainel']))
                                    $GrupoDescricao = $valoresGrupo['Descricao'];
                                 else
                                     $GrupoDescricao= $valoresGrupo['DescricaoPainel'];
                             }
...
//                                 }
//                                 else if ($iProduto > 19 && $iProduto <= 22)
//                                 {
//                                   $classeDescricao = "descricao-03";  
//                                 }
//                                 else if ($iProduto > 22 && $iProduto <= 27)
//                                 {
                                ...
                                <div class="<?php echo $linha; ?>">
                                    <div class="overflow">
                                        <div class="over-col-01-d">
                                            <p class="p-tabela <?php echo "descricao-02"; ?> linha-oferta"><?php echo substr($valores['DescCml'],0,21); ?></p>
                                        </div>                                        
                                        <div class="over-col-02-d"> 
                                            <p class="alinhamento-direita descricao-02"><?php echo "<span class='Vermelho FundoAmarelo'>".number_format($valores['ValorPor'],2,","," ")."</span>"; ?></p>                                            
                                        </div>
                                    </div>
                                </div>
                                <?php
...
//                            }
                                ...
                                <div class="slide">
                                    <div class="overflow">
                                        <div>
                                           <img src="template/img/imagem-11.jpg" alt="" width="390px" height="295px" />
                                        </div>
                                    </div>
                                </div>
                                <div class="slide">
                                    <div class="overflow">
                                        <div>
                                           <img src="template/img/imagem-12.jpg" alt="" width="390px" height="295px" />
                                        </div>
                                    </div>
                                </div>
                                <div class="slide">
                                    <div class="overflow">
                                        <div>
                                           <img src="template/img/imagem-13.jpg" alt="" width="390px" height="295px" />
                                        </div>
                                    </div>
                                </div>
                                <div class="slide">
                                    <div class="overflow">
                                        <div>
                                           <img src="template/img/imagem-14.jpg" alt="" width="390px" height="295px" />
                                        </div>
                                    </div>
                                </div>
                                <div class="slide">
                                    <div class="overflow">
                                        <div>
                                           <img src="template/img/imagem-15.jpg" alt="" width="390px" height="295px" />
                                        </div>
                                    </div>
                                </div>
                                <div class="slide">
                                    <div class="overflow">
                                        <div>
                                           <img src="template/img/imagem-16.jpg" alt="" width="390px" height="295px" />
                                        </div>
                                    </div>
                                </div>
                            <?php //}?>
