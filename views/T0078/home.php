 ...
 * Descrição: Programa para listar todos os tipos de atendimentos
 * Entradas:   
...
$entidades      =   $obj->retornaEntidades();
    ...
    <ul class="lista-itens-head">
        ...
        <li>
            <div class="padding-padrao-vertical celula-01 conteudo-visivel">
                ...
                <div class="coluna c02_tipo_b_01 margim-5px-horizontal">
                    <p class="negrito texto-alinhado-esquerda">Nome</p>
                </div>

                <div class="coluna c02_tipo_b_02 margim-5px-horizontal">
    ...
    <ul class="lista-itens-body">    
        ...
        <li class="dados">
            ...
            <div class="padding-2px-vertical <?php echo $celula; ?> conteudo-visivel">
                ...
                <div class="coluna c02_tipo_b_01 margim-5px-horizontal">
                    <p class="texto-alinhado-esquerda"><?php echo $valores['Codigo']." - ".$valores['Nome']; ?></p>
                </div>
