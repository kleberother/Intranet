 ...
 * Criado em: 32/01/2012 por Jorge Nova
 * Descrição: Programa para listar todos os funcionários
 * Entradas:   
...
if (!empty($_POST))
{
    ...
    if (!empty ($FiltroNome))
        $filtros    .=  " AND TF1.T052_nome LIKE '%$FiltroNome%'";
        
}

// Faz o select de lojas para Select Box
$retornaLojas   =   $obj->retornaLojas();

// Faz o select para retornar os colaboradores
$retornaColab   =   $obj->retornaColaboradores($filtros);
...
<div class="div-primaria padding-padrao-vertical">
        ...
        <li>
            <div class="padding-padrao-vertical celula-01 conteudo-visivel">
                ...
                <div class="coluna c05_tipo_b_01 margim-5px-horizontal">
                    <p class="negrito texto-alinhado-esquerda">Matrícula</p>
                </div>
                ...
                <div class="coluna c05_tipo_b_03 margim-5px-horizontal">
                    <p class="negrito texto-alinhado-esquerda">Setor / Cargo</p>
                </div>
    ...
    <ul class="lista-itens-body">    
        ...
        foreach($retornaColab as $campos=>$valores)
        {
        ...
        <li class="dados">
            ...
            <div class="padding-2px-vertical <?php echo $celula; ?> conteudo-visivel">
                ...
                <div class="coluna c05_tipo_b_01 margim-5px-horizontal">
                    <p class="texto-alinhado-esquerda"><?php echo $valores['Matricula']; ?></p>
                </div>
                ...
                <div class="coluna c05_tipo_b_03 margim-5px-horizontal">
                    <p class="texto-alinhado-esquerda"><?php echo $valores['Setor']."/".$valores['Cargo']; ?></p>
                </div>

                <div class="coluna c05_tipo_b_04 margim-5px-horizontal">
                    <p class="texto-alinhado-esquerda"><?php echo $valores['NomeLoja']; ?></p>
                </div>
