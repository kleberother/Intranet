...
<div class="div-primaria caixa-de-ferramentas padding-padrao-vertical">
    <ul class="lista-horizontal">
        <li><a href="?router=T0091/home"  class="abrirFiltros botao-padrao"><span class="ui-icon ui-icon-arrowthick-1-w"  ></span>Voltar </a></li>
    </ul>
</div>
    ...
    <ul class="lista-itens-head">
        ...
        <li>
            <div class="padding-padrao-vertical celula-01 conteudo-visivel">
                ...
                <div class="coluna c05_tipo_h_01 margim-5px-horizontal">
                    <p class="negrito texto-alinhado-esquerda">EAN</p>
                </div>

                <div class="coluna c05_tipo_h_02 margim-5px-horizontal">
                    <p class="negrito texto-alinhado-esquerda">Descrição</p>
                </div>

                <div class="coluna c05_tipo_h_03 margim-5px-horizontal">
                    <p class="negrito texto-alinhado-esquerda">Em Oferta[S/N]</p>
                </div>

                <div class="coluna c05_tipo_h_04 margim-5px-horizontal">
                    <p class="negrito texto-alinhado-esquerda">Em Linha</p>
                </div>

                <div class="coluna c05_tipo_h_05 margim-5px-horizontal">
