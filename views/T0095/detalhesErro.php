...
$retornaItens   =   $obj->retornaErros($codigoArquivo);
...
<div class="div-primaria caixa-de-ferramentas padding-padrao-vertical">
    <ul class="lista-horizontal">
        ...
        <li><a href="?router=T0095/js.pdfErro&cod=<?php echo $codigoArquivo;?>" target="_blank"  class="abrirFiltros botao-padrao"><span class="ui-icon ui-icon-print"  ></span>Imprimir </a></li>
    </ul>
</div>
        ...
        <li>
            <div class="padding-padrao-vertical celula-01 conteudo-visivel">
                ...
                <div class="coluna c06_tipo_g_05 margim-5px-horizontal">
                    <p class="negrito texto-alinhado-esquerda">Etiqueta(s)</p>
                </div>
