...
<div class="div-primaria caixa-de-ferramentas padding-padrao-vertical">
    <ul class="lista-horizontal">
        ...
        <li><a href="?router=T0095/js.pdfRuptura&cod=<?php echo $codigoArquivo;?>" target="_blank"  class="abrirFiltros botao-padrao"><span class="ui-icon ui-icon-print"  ></span>Imprimir </a></li>
    </ul>
</div>
