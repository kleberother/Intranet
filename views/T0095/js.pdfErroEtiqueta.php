...
class PDF extends FPDF
{
    ...
    $itens = $obj->retornaErrosEtiqueta($this->codigoAuditoria);
    ...
    function cabecalhoDados()
    {
        ...
        $this->Cell(82,5,utf8_decode("Descrição")       ,"TLRB",0,"L");
    ...
    function Header()
    {
        ...
        $this->Cell(120, 0, utf8_decode("RELATÓRIO DE PRODUTO(S) SEM ETIQUETA(S)"), 0, 1, "L");
    ...
    function ChapterBody()
    {
        ...
        {       
            ...
            $this->Cell(82,5,utf8_decode($valores['Descricao'])     ,"TLRB",0,"L");
