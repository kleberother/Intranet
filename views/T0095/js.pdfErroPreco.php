...
class PDF extends FPDF
{
    ...
    function select()
    {
        ...
        $this->codigoAuditoria  =   $_REQUEST['codigoAuditoria'];

        $itens = $obj->retornaErrosPreco($this->codigoAuditoria);
    ...
    function cabecalhoDados()
    {
        ...
        $this->Cell(19,5,utf8_decode("Cód. RMS")      ,"TLRB",0,"L");
        $this->Cell(25,5,utf8_decode("EAN")             ,"TLRB",0,"L");
        $this->Cell(58,5,utf8_decode("Descrição")       ,"TLRB",0,"L");
        $this->Cell(18,5,utf8_decode("Prç RMS")         ,"TLRB",0,"L");
        $this->Cell(24,5,utf8_decode("Prç Auditado")    ,"TLRB",0,"L");
        $this->Cell(17,5,utf8_decode("Em Linha")        ,"TLRB",0,"L");
        $this->Cell(12,5,utf8_decode("Oferta")          ,"TLRB",0,"L");
        $this->Cell(17,5,utf8_decode("Etiquetas")       ,"TLRB",1,"L");
    }
    ...
    function Header()
    {
        ...
        $this->Cell(120, 0, utf8_decode("RELATÓRIO DE RUPTURAS - COMERCIAL"), 0, 1, "L");
    ...
    function ChapterBody()
    {
        ...
        {       
            ...
            $this->Cell(19,5,utf8_decode($valores['CodigoRMS'])     ,"TLRB",0,"L");
            $this->Cell(25,5,utf8_decode($valores['Ean'])           ,"TLRB",0,"L");
            $this->Cell(58,5,utf8_decode($valores['Descricao'])     ,"TLRB",0,"L");
            $this->Cell(18,5,utf8_decode($valores['PrecoRMS'])      ,"TLRB",0,"L");
            $this->Cell(24,5,utf8_decode($valores['PrecoAuditado']) ,"TLRB",0,"L");
            $this->Cell(17,5,utf8_decode($valores['Emlinha'])       ,"TLRB",0,"L");
            $this->Cell(12,5,utf8_decode($valores['Oferta'])        ,"TLRB",0,"L");
            $this->Cell(17,5,utf8_decode($valores['Etiqueta'])      ,"TLRB",1,"L");
...
$pdf      = new PDF();
$pdf->SetTitle(utf8_decode("[Auditoria Preço] - Relatório de Erros"));
