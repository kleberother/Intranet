...
class PDF extends FPDF
{
    ...
    $itens = $obj->retornaSemCadastro($this->codigoAuditoria);
    ...
    function cabecalhoDados()
    {
        ...
        $this->Cell(28,5,utf8_decode("Preço Auditado") ,"TLRB",0,"L");
    ...
    function Header()
    {
        ...
        $this->Cell(30);
        $this->Cell(120, 0, utf8_decode("RELATÓRIO ITENS FORA SELEÇÃO "), 0, 1, "L");
    ...
    function ChapterBody()
    {
        ...
        {       
            ...
            $this->Cell(28,5, money_format('%.2n', $valores['PrecoAuditado'])   ,"BLR",0,"L");
...
$pdf      = new PDF();
$pdf->SetTitle(utf8_decode("[Auditoria Preço] - Relatório de Itens sem Cadastro"));
