...
$RequestUri  =  $_SERVER['REQUEST_URI']     ;
 $tabela =   "T106_T060"                    ;
    ...
    $delim  =   "T106_codigo = ". $_GET["cod"] ." AND T060_codigo = ". $_GET["EtapaCodigo"]   ;
    $campos = array(
                        "T106_T060_status"          =>  1
...
//    //Verifica se está aprovando a ultima etapa da Despesa
    ...
    if($EtapaCodigo == $UltimaEtapaCodigo)
...
header("location:?router=T0111/home&status=".$status,"&filtros=".$filtros);
